<x-filament-panels::page>
    <div class="space-y-4">
        ...
        @endphp
        @if (count($stats))
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-{{ $cols }} lg:grid-cols-3 xl:grid-cols-4">
                            ...
                            <div class="group relative flex flex-col overflow-hidden rounded-xl bg-white text-left shadow-sm ring-1 ring-gray-950/5 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:bg-gray-900 dark:hover:bg-gray-800">
                                ...
                                <div class="flex items-center gap-1 border-t border-gray-100 px-3 py-2 dark:border-gray-800">
                                    <button
                                        ...
                                        wire:click="mountAction('edit', { id: {{ $item->id }} })"
                                    ...
                                    <button
                                        ...
                                        wire:click="mountAction('delete', { id: {{ $item->id }}, label: '{{ addslashes($item->nama_ruangan) }}' })"
                            ...
                            <div class="group relative flex flex-col overflow-hidden rounded-xl bg-white text-left shadow-sm ring-1 ring-gray-950/5 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:bg-gray-900 dark:hover:bg-gray-800">
                                ...
                                <div class="flex items-center gap-1 border-t border-gray-100 px-3 py-2 dark:border-gray-800">
                                    ...
                                    <button
                                        ...
                                        wire:click="mountAction('delete', { id: {{ $item->id }}, label: '{{ addslashes($item->nama_lokasi) }}' })"
                                        class="flex items-center gap-1 rounded px-2 py-1 text-xs text-red-500 transition hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-900/20"
                                    >
                                        <x-heroicon-o-trash class="h-3.5 w-3.5" /> Hapus
                                    </button>
                        ...
                        @foreach ($items as $item)
                            ...
                            <div class="group relative flex flex-col overflow-hidden rounded-xl bg-white text-left shadow-sm ring-1 ring-gray-950/5 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:bg-gray-900 dark:hover:bg-gray-800">
                                ...
                                <div class="flex items-center gap-1 border-t border-gray-100 px-3 py-2 dark:border-gray-800">
                                    ...
                                    <button
                                        wire:click="mountAction('delete', { id: {{ $item->id }}, label: '{{ addslashes($item->nama_rak) }}' })"
                                        class="flex items-center gap-1 rounded px-2 py-1 text-xs text-red-500 transition hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-900/20"
                                    >
                                        <x-heroicon-o-trash class="h-3.5 w-3.5" /> Hapus
                                    </button>
                            ...
                            <div class="group relative flex flex-col overflow-hidden rounded-xl bg-white text-left shadow-sm ring-1 ring-gray-950/5 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:bg-gray-900 dark:hover:bg-gray-800">
                                ...
                                @if ($item->qr_code_url)
                                    <div class="flex items-center gap-1 border-t border-gray-100 px-3 py-1 dark:border-gray-800">
                                        ...
                                        <button
                                            wire:click="mountAction('delete', { id: {{ $item->id }}, label: '{{ addslashes($item->nama_box) }}' })"
                                            class="flex items-center gap-1 rounded px-2 py-1 text-xs text-red-500 transition hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-900/20"
                                        >
                                            <x-heroicon-o-trash class="h-3.5 w-3.5" /> Hapus
                                        </button>
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <div class="mt-2 flex flex-wrap items-center gap-3">
                                    ...
                                    <div class="ml-auto flex items-center gap-1">
                                        ...
                                        <button
                                            wire:click="mountAction('delete', { id: {{ $item->id }}, label: '{{ addslashes($item->judul) }}' })"
                                            class="flex items-center gap-1 rounded px-2 py-1 text-xs text-red-500 transition hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-900/20"
                                        >
                                            <x-heroicon-o-trash class="h-3.5 w-3.5" /> Hapus
                                        </button>
